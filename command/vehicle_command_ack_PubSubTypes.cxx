...
vehicle_command_ack_PubSubType::vehicle_command_ack_PubSubType() {
	...
	m_typeSize = (uint32_t)vehicle_command_ack_::getMaxCdrSerializedSize();
...
std::function<uint32_t()> vehicle_command_ack_PubSubType::getSerializedSizeProvider(void* data) {
    return [data]() -> uint32_t { return (uint32_t)type::getCdrSerializedSize(*static_cast<vehicle_command_ack_*>(data)); };
}
